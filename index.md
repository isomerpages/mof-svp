...
sections:
  ...
  - infobar:
      ...
      description: <video max-width="500" max-height="375" controls> <source src="https://mof-svp-staging.netlify.app/images/Quickbuy@Sgov-final.m4v" type="video/mp4"><source src="movie.ogg" type="video/ogg">The video cannot be viewed in your browser</video>The initiative enables public officers to make efficient and
